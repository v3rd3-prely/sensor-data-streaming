...
/**
 * Central configuration class for the application. Stores Kafka topics and
...
public class Config {
	...
	/**
	 * Environment variable name used to configure Kafka bootstrap servers.
	 */
	...
	/**
	 * Returns the Kafka bootstrap servers address. Uses the environment variable if
	 * available, otherwise returns the default Kafka address.
	 *
